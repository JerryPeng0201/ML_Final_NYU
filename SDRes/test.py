...
parser.add_argument("-dp", "--data_path", type=str, default='/scratch/ujs204/', help="Path to the FSC147 dataset")
...
parser.add_argument("-m",  "--model_path", type=str, default="/scratch/ujs204/proj/runs/train/FamNet.pth", help="path to trained model")
...
anno_file = data_path + 'FSC147_384_V2/annotation_FSC147_384.json'
data_split_file = data_path + 'FSC147_384_V2/Train_Test_Val_FSC_147.json'
#im_dir = data_path + 'images_384_VarV2'
im_dir = data_path + 'FSC147_384_V2/images_384_VarV2'
gt_dir = data_path + 'FSC147_384_V2/gt_density_map_adaptive_384_VarV2'
...
print("Show whether we are using the GPU")
print(use_gpu)
