...
import copy
from model import Regressor, ResNet
from utils import MAPS, Scales, Transform, extract_features
from utils1 import MincountLoss, PerturbationLoss
...
parser.add_argument("-m",  "--model_path", type=str, default="./runs/train2/FamNet_best_1412.pth", help="path to trained model")
...
parser.add_argument("-g",  "--gpu-id", type=int, default=0, help="GPU id. Default 0 for the first GPUc Use -1 for CPU.")
